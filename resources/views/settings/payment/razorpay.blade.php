			...
			<div class="card-body"> 
				<form method="post" class="basicform" action="{{ route('seller.payment.update',$info->active_getway->id) }}">
					...
					<div class="card-body">
						...
						<div class="form-group">
							<label>key_id</label>
							<input class="form-control" required="" value="{{ $data->key_id }}" name="key_id" required="" type="text">
						</div>

						<div class="form-group">
							<label>key_secret</label>
							<input class="form-control" required="" value="{{ $data->key_secret }}" name="key_secret" required="" type="text">
						</div>
