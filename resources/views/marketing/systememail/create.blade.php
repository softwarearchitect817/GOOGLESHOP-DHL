...
@include('layouts.partials.headersection',['title'=>'System Email'])
@endsection
@section('content')
 <div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4>{{ __('System Email') }}</h4><br>
       
      </div>
      <div class="card-body">
        <form class="basicform" enctype="multipart/form-data" action="{{ route('seller.store-systememail') }}" method="post">
          @csrf
        ...
        <div class="form-group row mb-4">
         ...
         <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 text-primary" >{{ __('template for') }}</label>
          <div class="col-sm-12 col-md-7">
            <input type="text" class="form-control" required="" name="template_for" placeholder="Template for">
          </div>
        </div>
        <div class="form-group row mb-4">
